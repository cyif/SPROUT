...
namespace ZJUGame {
	...
	public class Player : MonoBehaviour {
		...
		[HideInInspector]
		public bool usingWall = false;						//
		[HideInInspector]
		public int usingTanhuang = 0;
		[HideInInspector]
		...
		void Start () {
			...
			//ladder.gameObject.active = false;
...
//				usingTanhuang = 1;
//				playerJump.holdToJumpHigher.initialJump = 10;
//			}

//			if (Input.GetKeyDown (KeyCode.H)) {
//				ladder.gameObject.SetActive(!ladder.gameObject.activeSelf);
//			}
